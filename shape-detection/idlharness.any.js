...
idl_test(
  ...
  async idl_array => {
    ...
    try {
      faceDetectionTest = await initialize_detection_tests("FaceDetectionTest");
      barcodeDetectionTest = await initialize_detection_tests("BarcodeDetectionTest");
      ...
      const barcodeDetectionResult = await barcodeDetector.detect(theImageBitmap);
